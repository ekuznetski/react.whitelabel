      ...
      <>
        ...
        <Col xs={12} className="context mb-lg-9 mb-7">
          ...
          <Trans i18nKey="Regional Restrictions Desc">
            We do not offer our services to residents of certain jurisdictions such as Afghanistan, Belgium, Hong Kong, Japan, the United States of America and some other regions. For more information please refer to our <a target="_blank" href={files.termsOfService}>Terms and Conditions</a>
          </Trans>
        </Col>
      </>
    ),
