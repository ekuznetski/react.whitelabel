import { Svg, Cards, ISingleCard, Button, SectionBg } from '@components/shared';
		...
		<div className="contacts-wrapper">
			<section className="page-top">
				...
				<Container className="pt-14">
					<Row>
						<Col xs={12}>
							<div className="page-top__title mb-9">Contact us</div>
			...
			<section className="offices pt-0 mt-md-n5">
				<Container>
					<Row>
						<Col xs={12}>
							<div className="offices__title mb-5">Our Offices</div>
							<div className="offices__description mb-13">
