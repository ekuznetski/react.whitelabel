import { Button, Checkbox, CountrySelect, Input, LocaleLink, PageTitle, PhoneCodeSelect, TextArea } from '@components/shared';
...
export const BrokersForm = memo(() => {
  ...
  function Submit(data: FormikValues) {
    console.log(data)
    dispatch(
      ac_partnershipRegisterIB(data as IPartnershipIBRegisterRequest,() => {
