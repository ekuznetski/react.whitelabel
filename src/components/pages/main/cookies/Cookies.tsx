...
import { BackButton, Col, Img, Row, Table } from '@components/shared';
import { cookiesTable } from './Cookies.config';
import './Cookies.scss';
...
export function Cookies() {
  ...
  return (
    <>
      ...
      <div className="cookies-wrapper container">
        <Row>
          <Col>
            <b>What are cookies?</b>
            <br />
            <br />
            Cookies are small pieces of text stored on your computer when you visit a website. They are not programs and
            cannot be executed as code or deliver viruses – instead cookies act more like a passport, which the site
            checks and updates whenever you visit.
            <br />
            <br />
            ...
            <br />
            <br />
            UINVEX respects your privacy, and we are committed to providing you with the information and tools you need
            ...
            <ul>
              ...
              <li>
                ...
                information you need and allow us to adapt our site to suit your preferences. Some of the systems we use
                to track web traffic and site usage are provided by third-party companies such as Google.
              </li>
            </ul>
            <br />
            On your desktop, laptop or tablet computer, you can choose how to accept cookies by changing the settings in
            your browser. For information on how to manage cookies on your mobile phone, you will need to refer to your
            handset manual.
            <br />
            <br />
            We are also currently developing a built-in solution for our site, giving you more control over the cookies
            you accept.
            <br />
            <br />
            ...
            , which contains instructions on how to amend your cookie settings for a wide variety of browsers. You will
            also find details on how to delete existing cookies from your computer, as well as more general information
            about cookies.
            <br />
            <br />
            ...
            ‘remember’ the open/closed status of pop-up messages, what time zone or view state was set for the Economic
            Calendar, enabling access to information stored when registered with UINVEX and so on. Without these
            functional cookies, no settings information can be saved.
            <br />
            <br />
            ...
            dissemination of these cookies. These cookies are session, analytical, and functional; they determine if the
            user is logged into a social network already, control bookmarking or sharing UINVEX content, and determine
            if you have Flash player installed when viewing our videos. UINVEX uses Adobe Flash Player to display this
            content. Flash cookies (Local Shared Objects) are used to verify if the user’s browser supports Flash. If
            you wish to disable Flash cookies, please visit www.adobe.com/products/flashplayer/security. Other third
            parties should be contacted directly to view their cookie privacy information.
            <br />
            <br />
            <b>Cookies Table</b>
            <br />
            ...
            <br />
            <br />
            We are planning to enhance our cookie tool to allow users to more easily change their cookie settings after
            their initial choice.
            <br />
            <br />
            If you are a UINVEX client there are certain behavioural/analytical cookies that you will need to accept in
            order to use our trading platform. If you’d ike to know more about good practice in online advertising,
