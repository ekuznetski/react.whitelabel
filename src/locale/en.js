export default {
  ...
  'Platform Page Top Title': '<0>World-Leading</0><1>MetaTrader Platform</1><2>Powered by AroFX</2>',
  ...
  Industry: 'Industry',
  'Current Employed for less than 3 years':
    'If current employed for less than 3 years provide the following information:',
  'Previous Employer’s Name': 'Previous Employer’s Name',
  'Previous Nature of Business': 'Previous Nature of Business',
  'Previous Position and Responsibilities': 'Previous Position and Responsibilities',
  'Previous Years of Employment': 'Previous Years of Employment',
  'Previous Location of Employment': 'Previous Location of Employment',
  ...
  'Invalid bank name': 'Enter numbers, latin characters and -.,/() only',
  'Invalid SWIFT Code': 'Invalid SWIFT Code',
  'Include latin characters, dash and apostrophe only': 'Include latin characters, dash and apostrophe only',
  'Invalid address': "Only numbers, latin characters and special characters -'.,#/ are allowed",
  'Invalid address mobile': "Enter numbers, latin characters and -'.,#/ only",
  'Please include only numbers': 'Please include only numbers',
  'Please include numbers and dots only': 'Please include numbers and dots only',
  'Please include latin characters only': 'Please include latin characters only',
  'Please include latin characters and digits only': 'Please include latin characters and digits only',
  'Password should contain digits and letters': 'Password should contain digits and letters',
  'Name must not exceed characters': 'Name must not exceed ${max} characters',
  ...
  'Please enter home address': 'Please enter home address',
  'Please enter previous home address': 'Please enter previous home address',
  'Please enter street name and number': 'Please enter street name and number',
  ...
  'Please enter years at current address': 'Please enter years at current address',
  'Please enter your employment status': 'Please enter your employment status',
  'Please enter other reason': 'Please enter other reason',
  'Please enter your industry name': 'Please enter your industry name',
  'Please select industry of financial services related': 'Please select industry of financial services related',
  "Please enter your employer's name": "Please enter your employer's name",
  'Please enter nature of business': 'Please enter nature of business',
  'Please enter your position and responsibilities': 'Please enter your position and responsibilities',
  'Please enter years of employment': 'Please enter years of employment',
  'Please select an answer': 'Please select an answer',
  "Please enter your employer's address": "Please enter your employer's address",
  "Please enter your employer's contact number": "Please enter your employer's contact number",
  'Please enter other income generating activites': 'Please enter other income generating activites',
  'Please enter total approximate annual income': 'Please enter total approximate annual income',
  'Please enter approximate net worth': 'Please enter approximate net worth',
  'Please enter anticipated funds available for trading': 'Please enter anticipated funds available for trading',
  "Please enter previous employer's name": "Please enter previous employer's name",
  'Please enter previous nature of business': 'Please enter previous nature of business',
  'Please enter previous position and responsibilities': 'Please enter previous position and responsibilities',
  'Please enter previous location of employment': 'Please enter previous location of employment',
  'Please enter previous approximate annual income': 'Please enter previous approximate annual income',
  'You must check the declaration': 'You must check the declaration',
  'Maximum length symbols': 'Maximum length ${max} symbols',
  'Minimum length symbols': 'Minimum length ${min} symbols',
  'Maximum length numbers': 'Maximum length ${max} numbers',
  'Minimum length numbers': 'Minimum length ${min} numbers',
  'Maximum length characters': 'Maximum length ${max} characters',
  'Day Limit': 'Day must be less or equal to ${max}',
  'Year Limit': 'You must be 18+ to access our services',
  ...
  'Forex (Exotic)': 'Forex (Exotic)',
  Cryptocurrency: 'Cryptocurrency',
  'Metals (Spot And Future)': 'Metals (Spot And Future)',
  'Indices Cash (US Indices)': 'Indices Cash (US Indices)',
  'Indices Cash (Others)': 'Indices Cash (Others)',
  'Indices Future (US Indices)': 'Indices Future (US Indices)',
  'Indices Future (EU,JP and HK)': 'Indices Future (EU,JP and HK)',
  'Indices Future (India and China)': 'Indices Future (India and China)',
  'Commodities (Natgas)': 'Commodities (Natgas)',
  'Commodities (US oil and Brent)': 'Commodities (US oil and Brent)',
  'Commodities (Soft)': 'Commodities (Soft)',
  'Stocks (France)': 'Stocks (France)',
  'Stocks (Germany)': 'Stocks (Germany)',
