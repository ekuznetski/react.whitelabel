...
export default {
  ...
  'Footer Authorized':
    'Uinvex Ltd is authorized and regulated under the Cayman Islands Monetary Authority under reference number XXXX',
  ...
  'Platform Page Top Title': '<0>Cutting edge</0><1><0>MetaTrader 5</0> platform</1><2>powered by <1>UINVEX</1><2/></2>',
};
