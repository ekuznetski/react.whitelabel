...
export const createMT4LiveAccountRequest = request(EHttpMethod.post, `${env.API_URL}/accounts/mt4/create`);
export const createMT4DemoAccountRequest = request(EHttpMethod.post, `${env.API_URL}/accounts/mt4/demo/create`);
export const createMT5LiveAccountRequest = request(EHttpMethod.post, `${env.API_URL}/accounts/mt5/create`);
export const createMT5DemoAccountRequest = request(EHttpMethod.post, `${env.API_URL}/accounts/mt5/demo/create`);
export const changeAccountPasswordRequest = request(EHttpMethod.post, `${env.API_URL}/accounts/mt5/changePassword`); // TODO update path when Ralph update endpoint
export const changeAccountLeverageRequest = request(EHttpMethod.post, `${env.API_URL}/accounts/mt4/changeLeverage`); // TODO update path when Ralph update endpoint
...
export const getPricesRequest = request(EHttpMethod.get, `${env.API_URL.replace('api', 'prices')}/graphs/homepage`);
