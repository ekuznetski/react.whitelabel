...
export const marketTableContent: { [key: string]: IMarketTableContent[] } = {
  [EAssetClass.forex]: [
    ...
    // {instr: 'EURUSD-Futures'	,fixed:'18.0'	,classic:'17.0'	,raw:'9.0'    ,swap_l:'0.00%'    ,swap_s:'0.00%',	lotSize:'100,000 EUR'	,minTrade:'1.000 EUR'	,valuePerTick:'1 USD'	,platform: [ETradingPlatform.mt5]},
    // {instr: 'AUDUSD-Futures'	,fixed:'25.0'	,classic:'23.0'	,raw:'15.0'   ,swap_l:'0.00%'    ,swap_s:'0.00%',	lotSize:'100,000 AUD'	,minTrade:'1.000 AUD'	,valuePerTick:'1 USD'	,platform: [ETradingPlatform.mt5]},
    // {instr: 'NZDUSD-Futures'	,fixed:'37.0'	,classic:'34.0'	,raw:'26.0'   ,swap_l:'0.00%'    ,swap_s:'0.00%',	lotSize:'100,000 NZD'	,minTrade:'1.000 NZD'	,valuePerTick:'1 USD'	,platform: [ETradingPlatform.mt5]},
    // {instr: 'CADUSD-Futures'	,fixed:'28.0'	,classic:'25.0'	,raw:'17.0'   ,swap_l:'0.00%'    ,swap_s:'0.00%',	lotSize:'100,000 CAD'	,minTrade:'1.000 CAD'	,valuePerTick:'1 CAD'	,platform: [ETradingPlatform.mt5]},
    // {instr: 'CHFUSD-Futures'	,fixed:'28.0'	,classic:'27.0'	,raw:'19.0'   ,swap_l:'0.00%'    ,swap_s:'0.00%',	lotSize:'100,000 CHF'	,minTrade:'1.000 CHF'	,valuePerTick:'1 CHF'	,platform: [ETradingPlatform.mt5]},
    // {instr: 'GBPUSD-Futures'	,fixed:'25.0'	,classic:'25.0'	,raw:'17.0'   ,swap_l:'0.00%'    ,swap_s:'0.00%',	lotSize:'100,000 GBP'	,minTrade:'1.000 GBP'	,valuePerTick:'1 USD'	,platform: [ETradingPlatform.mt5]},
    // {instr: 'JPYUSD-Futures'	,fixed:'23.0'	,classic:'20.0'	,raw:'12.0'	,swap_l:'0.00%'	    ,swap_s:'0.00%',	lotSize:'10,000,000 JPY',minTrade:'100.000 JPY'	,valuePerTick:'100 JPY'	,platform: [ETradingPlatform.mt5]}
  ],
  [EAssetClass.stocks]: [
    {
